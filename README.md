# Java Project Comment Formatter
...
```git_command
git init
git remote add origin https://github.com/rzrasel/java-comment-formatter.git
git remote -v
...
```executable_jar
cd /path/to/CommentFormatterProject
mkdir -p bin
...
```executable_jar
cd bin
jar cfm CommentFormatter.jar ../manifest.txt *

java -jar CommentFormatter.jar
```
